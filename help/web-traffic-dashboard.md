---
description: Beschreibt das Dashboard „Web-Traffic“ für Besuche, Seitenansichten und Formulare zur Kanalleistung im Zeitverlauf
...
| KPI | Definition |
| --- | --- |
| Besuche | Die Gesamtzahl der Seitenbesuche (Sitzungen), die von externen Seiten aus initiiert wurden und bekannte und anonyme Benutzer umfassen. |
| Besucher | Die Gesamtzahl der Unique Visitors. |
| Seitenansichten | Die Gesamtzahl der Aufrufe auf allen Webseiten. |
| Formulare | Die Gesamtzahl der Formularübermittlungen, einschließlich LinkedIn Lead Gen Forms. |
| Eindeutige E-Mails von Forms | Gesamtzahl der eindeutigen E-Mails aus Formularübermittlungen. |
| Leads aus Forms erstellt | Gesamtzahl der neuen Leads, die aus Formularübermittlungen erstellt wurden. |
...
![In welchem Zeitraum wurde auf der Website die höchste Anzahl an eindeutigen Inhalten angezeigt](assets/web-dashboard-1.png)
...
![Lead-Erstellung aus Formularen](assets/web-dashboard-2.png)
...
![Wie lässt sich die Anzahl der Unique Visitors mit der Gesamtzahl der Besuche innerhalb von vergleichen](assets/web-dashboard-4.png)
