...
Weitere Informationen [finden Sie hier](/help/marketo-measure-tracking/adding-marketo-measure-script-via-google-tag-manager.md){target="_blank"}.
...
* Lösung: Diese [Vorlagen zum Melden von Benutzenden](/help/marketo-measure-tracking/ajax-form-handling.md){target="_blank"} können von Ihrem Web-Entwicklungs-Team verwendet werden, um den erforderlichen Code hinzuzufügen.
