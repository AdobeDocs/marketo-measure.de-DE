...
Erfahren Sie mehr über [Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}.
...
![Wählen Sie aus einer Quelle die Option Datenverwendungsvorlagen hinzufügen aus](assets/marketo-guide-2.png)

* Wählen Sie ein Konto und alle B2B-Vorlagen aus, um zehn standardmäßige B2B-Schemata zu erstellen.

![Wählen Sie ein Konto und alle B2B-Vorlagen aus, um zehn standardmäßige B2B-Vorlagen zu erstellen](assets/marketo-guide-3.png)
...
1. Ordnen Sie die Felder aus der Quelle dem Schema zu.
   ...
   >[!NOTE]
   >
   >[Datenintegritätsanforderung in Marketo Measure Ultimate](/help/data-integrity-requirement.md){target="_blank"}
...
![Option 1: Um Abfragen direkt über die Benutzeroberfläche auszuführen, greifen Sie auf die Abfragen zu](assets/marketo-guide-4.png)
...
![Benutzer können Stadien aus verschiedenen Quellen zuordnen.](assets/marketo-guide-5.png)

Wenn die Phasen nicht zugeordnet sind, funktioniert das System nicht, da die Daten nicht weitergegeben werden können.

Wenn Sie Kundin oder Kunde von Marketo Measure Ultimate sind und Ihr Standard-Dashboard-Objekt auf „Kontakt“ festgelegt haben, verwenden Sie folgende beiden Lead-Felder nicht ([mehr dazu erfahren Sie hier](/help/data-integrity-requirement.md){target="_blank"}).
