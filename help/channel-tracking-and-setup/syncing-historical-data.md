---
description: Anleitung zum Synchronisieren historischer Daten für Marketo Measure-Benutzende
...
![Um historische Online-Daten zu synchronisieren, müssen die Daten in Salesforce organisiert sein](assets/dynamics-lists-1.png)
...
![Wenn die Daten an einem anderen Ort gespeichert sind (z. B. noch im Marketing leben](assets/dynamics-lists-10.png)
...
Weitere Informationen zum Synchronisieren von Marketing-Listen finden Sie hier: [[!DNL Dynamics] Kampagnen und Marketing-Listen](/help/channel-tracking-and-setup/dynamics-campaigns-and-marketing-lists.md)
...
| Veranstaltungen - Partnerveranstaltungen | Ereignisse | Partnerveranstaltungen |
