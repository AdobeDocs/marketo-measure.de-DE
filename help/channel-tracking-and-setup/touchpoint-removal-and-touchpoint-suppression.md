...
![Wählen Sie aus einer Liste von Benutzern, die sich auf den nächsten beziehen](assets/touchpoint-settings-10.png)
...
![Oder fügen Sie neue Anweisungen außerhalb der Gruppe hinzu, um die Logik „OR“ zu verwenden](assets/touchpoint-settings-11.png)
...
![3) Wenn Ihre Regeln komplex werden und Sie Gruppen neu erstellen müssen](assets/touchpoint-settings-6.png)
...
![Wenn du einen Fehler machst, mach dir keine Sorgen. Sie können einzelne Zeilen löschen](assets/touchpoint-settings-7.png)
