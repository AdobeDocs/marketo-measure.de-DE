...
![Tabellenvorlage mit drei Spalten für Salesforce-Kampagnentyp, -Kanal und -Unterkanal](assets/1-2.png)
...
![Registerkarte Offline-Kanäle mit der Liste Salesforce-Kampagnentyp](assets/2-2.png)
...
![Abschnitt „Kanäle erstellen“ mit der Benutzeroberfläche zum Erstellen neuer Kanäle und Unterkanäle](assets/3-2.png)
...
![Falsche Kanalzuordnung, bei der derselbe Kampagnentyp verschiedenen Unterkanälen zugeordnet wird](assets/4-2.png)
...
![Korrekte Kanalzuordnung mit eindeutigen Kampagnentypen für verschiedene Unterkanäle](assets/5-2.png)
...
![Abschnitt „Kanäle erstellen“ mit der Erstellung eines NULL-Kanals für Online-Kampagnen](assets/6-2.png)
...
> [Integration von Marketo Engage-Programmen](/help/marketo-measure-and-marketo/marketo-engage-programs-integration.md#channel-mapping){target="_blank"}
