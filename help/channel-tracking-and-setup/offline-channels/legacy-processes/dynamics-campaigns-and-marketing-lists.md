...
![Dynamics-Kampagnenantwortdatensatz mit Lead- oder Kontaktbeziehung](assets/1.png)
...
![Kampagnendatensatz mit benutzerdefiniertem Feld „Käufer-Touchpoints aktivieren“](assets/2.png)
...
![Feld „Käufer-Touchpoints aktivieren“ mit Dropdown-Optionen für die Einbeziehung von Kampagnen-Antworten](assets/3.png)

Dies sind die Stock-Antwortwerte für die Kampagnenantwort:

![Dropdown-Liste mit standardmäßigen Werten für Kampagnenreaktionen in Dynamics](assets/4.png)
...
Benutzerdefiniertes Feld für das ![Buyer Touchpoint-Datum zum Überschreiben des standardmäßigen Campaign-Antwortdatums](assets/5.png)
...
![Auswahl des Marketing-Listentyps mit statischen und dynamischen Optionen in Dynamics](assets/6.png)
...
![Kampagnendatensatz mit Umschalter-Feld Marketing-Listen synchronisieren](assets/7.png)
...
![Buyer Touchpoint-Datumsfeld für Mitglieder der Marketing-Liste](assets/8.png)
...
![Offline-Kanaleinstellungen, in denen Kampagnentypwerte in Marketo Measure angezeigt werden](assets/9.png)

![Konfiguration der Kanalzuordnung für Kampagnentypen mit Kanal- und Unterkanal-Optionen](assets/10.png)
