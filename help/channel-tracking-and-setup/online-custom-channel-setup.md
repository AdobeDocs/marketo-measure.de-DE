---
description: Online-Anleitung zur Einrichtung benutzerdefinierter Kanäle für Marketo Measure-Benutzende
...
![Der erste Schritt besteht darin, die benutzerdefinierte Kanal-Tabelle aus der herunterzuladen](assets/online-channels-1.png)

Die Tabelle enthält sieben Spalten:

![Das Arbeitsblatt hat sieben Spalten:](assets/online-channels-2.png)
...
![Die Zeilen stellen Regeln und die Reihenfolge dar, in der Marketo Measure ausgeführt wird](assets/online-channels-3.png)
...
![Marketo Measure verfügt über 12 Standardkanäle. Diese](assets/online-channels-4.png)
...
![Jeder Parameter oder jede Komponente der Regel wird separat der Regel zugeordnet](assets/online-channels-5.png)
...
![Der Standardkanal „Sonstige“ ist vorhanden, um Daten zu erfassen, die nicht übereinstimmen](assets/online-channels-6.jpg)
