---
description: Anleitung zur Einrichtung von benutzerdefinierten Offline-Kanälen für Marketo Measure-Benutzende
...
![Das Arbeitsblatt hat drei Spalten:](assets/offline-channels-1.png)
...
![Die SFDC-Kampagnentypen werden auf der Registerkarte Offline-Kanal angezeigt, die hier aufgeführt ist](assets/offline-channels-10.jpg)
...
![Hier können Sie die Kanal-/Unterkanal-Zuordnung im erstellen](assets/offline-channels-11.png)
...
![Im Folgenden finden Sie ein Beispiel für eine Logik, die Marketo Measure nicht verwenden würde](assets/offline-channels-12.png)
...
![Im obigen Szenario empfiehlt es sich, eine eindeutige Kampagne zu erstellen](assets/offline-channels-13.png)
...
Erfahren Sie mehr über [Synchronisieren von  [!DNL Salesforce]  mit [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md).
...
![Ein weiterer Tipp für die Handhabung von Kampagnen für Online-Aktivitäten ist die Zuordnung der](assets/offline-channels-14.png)
...
![Nachdem Sie die Tabelle mit Ihren benutzerdefinierten Regeln bearbeitet und aktualisiert haben, wird](assets/offline-channels-20.png)
