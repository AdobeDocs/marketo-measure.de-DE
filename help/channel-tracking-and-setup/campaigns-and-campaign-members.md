---
description: Anleitung für Kampagnen und Kampagnenmitglieder für Marketo Measure-Benutzende
...
![Wenn Sie vor der Verwendung von Marketo Measure eine Marketing-Automatisierungsplattform verwendet haben](assets/dynamics-lists-2.png)
...
![Das Touchpoint-Datum für die Massenaktualisierung ist in der installierten Marketo enthalten](assets/dynamics-lists-5.png)
...
![Klicken Sie nach der Einstellung von Datum und Uhrzeit auf die Option Ausgewählte aktualisieren](assets/dynamics-lists-6.png)

## Kampagnenkosten {#campaign-costs}

Informationen zu Kampagnenkosten finden Sie [in diesem Artikel](/help/crm-campaign-costs.md){target="_blank"}.
