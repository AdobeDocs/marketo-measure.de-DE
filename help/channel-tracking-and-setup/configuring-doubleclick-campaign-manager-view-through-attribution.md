...
>[!NOTE]
>
>Wenn Sie die Integration von [!DNL Marketo Measure] und [!DNL DoubleClick Campaign Manager] verwenden, benötigen wir eine [API-Verbindung](/help/api-connections/integrated-ad-platforms.md) damit wir Details zu den Kampagnen und Kreativen herunterladen können, um die Anzeigen aufzulösen.
...
Weitere Informationen zur Funktion „Durch Attribution anzeigen[!DNL Marketo Measure] finden Sie unter Häufig gestellte Fragen zur Ansicht über Attribution durch [Marketo Measure](/help/channel-tracking-and-setup/marketo-measure-view-through-attribution-faq.md).
...
1. Bestätigen Sie nach dem Hinzufügen, dass die Trennzeichen wie folgt zugeordnet sind. Dies sollte automatisch erfolgen, sobald das Tag angewendet wird:
   ...
   v = %HEADV! [!DNL Expand] Werbekunden-ID\
   ...
   ![n = %n Makro mit zufälliger Anzahl](assets/view-attribution-1.png)
