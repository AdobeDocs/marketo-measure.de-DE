---
description: Anleitung zu Touchpoint-Feldern für Marketo Measure-Anwender
...
>[!AVAILABILITY]
>
>Jetzt mit vollständiger Segmentierung in Stufe 2 und Stufe 3 verfügbar.
...
![Navigieren Sie im Menü Marketo Measure-Einstellungen zu den Touchpoint-Feldern](assets/touchpoint-fields-1.png)
...
Der [!UICONTROL extrahiert]-Operator ruft den Wert eines Felds von einem anderen Speicherort ab, z. B.: einem Kampagnenfeld, einem Lead-Feld oder in einem erweiterten Anwendungsfall [Extrahieren benutzerdefinierter Parameter aus der Landingpage](https://docs.google.com/document/d/1NRViyCsXvPKbCTfGW32Yi2vWBjMDRF7bzkzKj9s2DDA/edit?ts=5e20b482#heading=h.xxwtissvw4){target="_blank"}. Anschließend wird sie in ein Touchpoint-Feld platziert (siehe [Zuordnungen zu Beispiel](https://docs.google.com/document/d/1NRViyCsXvPKbCTfGW32Yi2vWBjMDRF7bzkzKj9s2DDA/edit?ts=5e20b482#heading=h.xxwtissvw4){target="_blank"} #2).
...
![Beachten Sie, dass Sie einen Schrägstrich und keinen verwenden](assets/touchpoint-fields-11.png)
...
![{6} ist die Anzahl der Zeichen, die extrahiert werden](assets/touchpoint-fields-12.png)
...
![{6} ist die Anzahl der Zeichen, die extrahiert werden](assets/touchpoint-fields-13.png)
...
![Es gibt Kampagnen, die Sie für eine „Ende-Sommer-Promotion“ erstellt haben](assets/touchpoint-fields-2.png)
...
![Um die 10 zu extrahieren, definieren Sie den Wert als „BZ=\d{2}-\d{2}-\d{2}-\d{2}-(\d{2})“](assets/touchpoint-fields-3.png)
...
![Es gibt separate Felder im Opportunity-Objekt für Segmente und Gradec](assets/touchpoint-fields-4.png)
...
![Die Möglichkeit, Segmente mithilfe von Touchpoint-Feldern zu erstellen, ist damit verfügbar](assets/touchpoint-fields-5.png)
...
![Ihre Einrichtung würde in etwa wie im folgenden Screenshot aussehen. Der Segmentname](assets/touchpoint-fields-6.png)

Die Regel verweist auf dasselbe Touchpoint-Feld und sucht nach Werten, die „nicht gleich null“ sind.

![Die Regel verweist auf dasselbe Touchpoint-Feld und sucht nach Werten, die](assets/touchpoint-fields-7.png)
...
![Es gibt ein Online-Tool (https://regex101.com/(https://regex101.com/){target="blank"}), das Sie ausführen und testen können](assets/touchpoint-fields-8.png)

![Es gibt ein Online-Tool (https://regex101.com/(https://regex101.com/){target="blank"}), das Sie ausführen und testen können](assets/touchpoint-fields-9.png)
