...
>[!NOTE]
>
>[Anleitung zum Einrichten von Boomerang-Stadien](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md).
...
![Ohne Boomerang-Stadien (das „Vorher„) wird nur die neueste MQL angezeigt](assets/boomerang-stages-18.png)
...
![Im folgenden Beispiel enthält dieses Marketo Measure-Konto MQL](assets/boomerang-stages-19.png)
