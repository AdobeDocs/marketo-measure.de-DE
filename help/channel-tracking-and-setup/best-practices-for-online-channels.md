---
description: Best Practices für die Anleitung von Marketo Measure-Benutzenden für Online-Kanäle
...
Nachdem Online-Kanal-Regeln gespeichert und verarbeitet wurden, arbeiten sie kontinuierlich daran, Ihre digitalen Touchpoints in Buckets zu sammeln. Bestimmte Änderungen oder Szenarien führen jedoch dazu, dass Sie die Einrichtung Ihres Online-Kanals überprüfen möchten. [!DNL Marketo Measure] empfiehlt, die Regeln für Online-Kanäle einmal alle sechs Monate zu überprüfen. Dadurch wird sichergestellt, dass Ihre [!DNL Marketo Measure]-Daten mit Ihren internen Definitionen von Online-Kanälen/-Unterkanälen und Ihrer Verwendung von UTMs abgestimmt sind.
...
>[!MORELIKETHIS]
> [Einrichtung des Online-Kanals](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
> [UTM-](/help/channel-tracking-and-setup/utm-parameters.md)
> [Marketing-Kanal und Unterkanal](/help/channel-tracking-and-setup/marketing-channels-and-subchannels.md)
