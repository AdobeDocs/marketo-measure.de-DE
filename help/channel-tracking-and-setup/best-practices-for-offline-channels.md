---
description: Anleitung zu Best Practices für Offline-Kanäle für Marketo Measure-Benutzende
...
>[!MORELIKETHIS]
> [Offline-Kanal-Setup](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
> [Benutzerdefinierte Kampagnensynchronisierung - App-Synchronisierung](/help/channel-tracking-and-setup/custom-campaign-sync.md)
> [Synchronisieren von Offline-Kampagnen - CRM-Synchronisierung](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
> [Offline-Kampagne und Kampagnenmitglieder - CRM-Synchronisation](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
> [Synchronisierungsdaten für Kampagnen - CRM-Synchronisierung](/help/channel-tracking-and-setup/campaign-sync-dates.md)
> [Konfigurationen für mehrere Kampagnen-Datensatztypen](/help/channel-tracking-and-setup/configurations-record-types.md)
> [Erstellen einer Kampagnen-Listenansicht](/help/channel-tracking-and-setup/creating-a-campaign-list-view-for-salesforce-campaigns.md)
