...
Standardmäßig sind Pipeline-Umsatzdaten nicht im Dashboard verfügbar, da Dynamics standardmäßig zwei Felder für das Abschlussdatum des Lagerbestands hat: Geschätztes Abschlussdatum und Tatsächliches Abschlussdatum. [!DNL Marketo Measure] kann nur auf ein Abschlussdatumsfeld im Dashboard verweisen und verweist auf das tatsächliche Abschlussdatum.
