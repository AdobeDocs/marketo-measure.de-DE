...
+ Konfiguration und Einrichtung {#configuration-and-setup}
   ...
   + [!DNL Marketo Measure] und Salesforce {#marketo-measure-and-salesforce}
      ...
      + [[!DNL Salesforce] Package-Konsolidierung](configuration-and-setup/marketo-measure-and-salesforce/salesforce-package-consolidation.md)
...
+ [!DNL Marketo Measure] Benutzeroberfläche von Discover {#marketo-measure-discover-ui}
   + Dashboards {#dashboards}
      ...
      + [Dokumentation zum Momentaufnahmen-Dashboard](marketo-measure-discover-ui/dashboards/snapshot-dashboard-documentation.md)
   + Verwenden der Reporting-Plattform von [!DNL Marketo Measure] {#using-marketo-measures-reporting-platform}
      ...
      + [Aufschlüsse](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/drill-throughs.md)
...
+ [!DNL Marketo Measure] und Adobe {#marketo-measure-and-adobe}
   ...
   + [Übersicht über die Adobe Experience Cloud-Benutzeroberfläche](marketo-measure-and-adobe/experience-cloud-interface-overview.md)
