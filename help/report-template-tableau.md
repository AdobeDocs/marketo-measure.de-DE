...
![Sie müssen die vorhandenen Verbindungsdaten für Ihre spezifische Snowflake aktualisieren](assets/marketo-tableau-7.png)

## Datenverbindung {#data-connection}

Sie müssen eine Datenverbindung zu Ihrer Snowflake-Instanz einrichten. Dazu benötigen Sie den Server-Namen sowie Ihren Benutzernamen und Ihr Passwort. Details darüber, wo Sie diese Informationen finden und Ihr Passwort gegebenenfalls zurücksetzen können, finden Sie [hier](/help/data-warehouse-access-reader-account.md){target="_blank"}.

![Sie müssen eine Datenverbindung zu Ihrer Snowflake-Instanz einrichten.](assets/marketo-tableau-5.png)
...
![Sie müssen auch einen ersten SQL-Befehl eingeben. Dies unterstützt](assets/marketo-tableau-6.png)
...
![Auf die Daten in Tableau wurden einige Umwandlungen angewendet](assets/marketo-tableau-1.png)

![Auf die Daten in Tableau wurden einige Umwandlungen angewendet](assets/marketo-tableau-2.png)
...
![Um den Berechnungen im Modell Währungsumrechnungsfunktionen hinzuzufügen, haben wir folgende Möglichkeiten](assets/marketo-tableau-4.png)
...
![Es gibt ein paar Stellen, an denen zwei Tische aus Snowflake haben](assets/marketo-tableau-3.png)
...
![In der Spalte KATEGORIE werden die Kategorienummer und die Spalte SEGMENTNAME aufgeführt](assets/marketo-tableau-13.png)
...
![Namen können auf zwei Arten aktualisiert werden. Die erste Option ist](assets/marketo-tableau-14.png)

Die andere Möglichkeit besteht darin, die Spalten direkt in der [!DNL Tableau]-Tabelle umzubenennen.

![Die andere Option besteht darin, die Spalten direkt im umzubenennen](assets/marketo-tableau-9.png)

## Datenmodell {#data-model}

Klicken Sie auf das folgende Bild, um es in voller Größe anzuzeigen.

[![Klicken Sie auf das Bild unten, um die vollständige Version anzuzeigen.](assets/marketo-tableau-8.png)](assets/tableau-model-1.png){target="_blank"}
...
![Dimensionen „Kosten- und Touchpoint-Datenfreigabe-Kanal“ und „Kampagne“. Allerdings Tableau](assets/marketo-tableau-10.png)
...
![Rechnet den Wert aus Firmenwährung in den ausgewählten Währungswert in Unternehmenswährung um](assets/marketo-tableau-11.png)
...
![Die Währungsumrechnungskennzahlen in diesem Modell ersetzen einen Wert von 1,0](assets/marketo-tableau-12.png)
...
![Es wurden Definitionen für benutzerdefinierte Parameter zum Tableau-Modell hinzugefügt](assets/marketo-tableau-15.png)
