...
Erfahren Sie mehr über [Marketo Measure Ultimate](/help/marketo-measure-ultimate/overview.md){target="_blank"}.
...
![Schemastrukturdiagramm mit Klassen- und Feldergruppenbeziehungen](assets/marketo-measure-ultimate-implementation-guide-1.png)
...
![Quellseite mit den Optionen Daten hinzufügen und Vorlagen verwenden](assets/marketo-measure-ultimate-implementation-guide-2.png)

* Wählen Sie ein Konto und alle B2B-Vorlagen aus, um zehn standardmäßige B2B-Schemata zu erstellen.

![Vorlagenauswahl mit B2B-Schemavorlagen für die Kontokonfiguration](assets/marketo-measure-ultimate-implementation-guide-3.png)
...
![Registerkarte „Abfragen“ im Daten-Management mit der Benutzeroberfläche für Abfragen](assets/marketo-measure-ultimate-implementation-guide-4.png)
...
![Staging-Zuordnungsschnittstelle mit Staging-Konfiguration aus mehreren Quellen](assets/marketo-measure-ultimate-implementation-guide-5.png)
