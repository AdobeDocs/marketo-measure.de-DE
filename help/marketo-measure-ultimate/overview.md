...
![Architekturdiagramm mit Marketo Measure Tiers 1-3-Datenfluss und Verbindungen](assets/marketo-measure-ultimate-overview-1.png)

**[!DNL Marketo Measure Ultimate]**

![Architekturdiagramm, das Marketo Measure Ultimate mit AEP-Integration zeigt](assets/marketo-measure-ultimate-overview-2.png)
...
![Datenflussdiagramm, das den B2B-Datenimport über die AEP-Plattform zeigt](assets/marketo-measure-ultimate-overview-3.png)
...
![Standardmäßige Währungseinstellungen mit USD-Währungsoption](assets/marketo-measure-ultimate-overview-4.png)
...
Sobald die Auswahl der Sandbox-Zuordnung gespeichert wurde, können Sie sie in der Anwendung nicht mehr ändern. Wenden Sie sich zur Änderung an den [Marketo-Support](https://nation.marketo.com/t5/support/ct-p/Support){target="_blank"}.
...
![Sandbox-Zuordnungskonfiguration mit Datensatz- und Datenflussbeziehungen](assets/marketo-measure-ultimate-overview-5.png)
...
![Staging-Zuordnungsschnittstelle mit integrierten und benutzerdefinierten Staging-Konfigurationen](assets/marketo-measure-ultimate-overview-6.png)

Touchpoint-Regeln für Kampagnenmitglieder und Touchpoint-Regeln für Aktivitäten sind datensatzspezifisch.

![Konfiguration der Touchpoint-Regeln für Kampagnenmitglieder nach Datensatz](assets/marketo-measure-ultimate-overview-7.png)

![Konfiguration der Touchpoint-Aktivitätsregeln nach Datensatz](assets/marketo-measure-ultimate-overview-8.png)
...
>[!MORELIKETHIS]
> [Marketo Measure Ultimate-Ziel](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/adobe/marketo-measure-ultimate.html?lang=de){target="_blank"}
> [VIDEO: Marketo Measure Ultimate - Überblick](https://experienceleague.adobe.com/de/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview){target="_blank"}
