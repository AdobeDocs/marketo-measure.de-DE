---
description: PostLC-Touchpoints und Lead-Interaktion
...
![Lead-Datensatz mit PostLC-Touchpoints in Salesforce](assets/1.png)
...
![PostLC Touchpoint-Liste auf vier letzte Einreichungen begrenzt](assets/2.png)
...
1. Geben Sie die Anzahl der PostLC-Touchpoints ein, die Sie an Ihre Leads senden möchten, und klicken Sie auf **[!UICONTROL Speichern]**.
   ...
   ![Seite Lead-Einstellungen zum Festlegen eines PostLC-Touchpoint-Limits](assets/3.png)
...
1. Geben Sie die Anzahl der PostLC-Touchpoints ein, die Sie an Ihre Kontakte senden möchten, und klicken Sie auf **[!UICONTROL Speichern]**.
   ...
   ![Seite Kontakteinstellungen zum Festlegen des PostLC-Touchpoint-Limits](assets/4.png)
