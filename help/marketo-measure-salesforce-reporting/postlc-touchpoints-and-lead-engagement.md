...
![Marketo Measure Post-Lead Creation (PostLC)-Touchpoints sind für Kunden verfügbar, die Folgendes verwenden](assets/additional-functionality-1.png)
...
![PostLC-Touchpoints sind dynamisch. Als Lead oder Kontakt übermittelt weiterhin](assets/additional-functionality-2.png)
...
1. Geben Sie die Anzahl der PostLC-Touchpoints ein, die Sie an Ihre Leads senden möchten, und klicken Sie auf **[!UICONTROL Speichern]**.
   ...
   ![1. Geben Sie die Anzahl der PostLC-Touchpoints ein, an die Sie pushen möchten](assets/additional-functionality-3.png)
...
1. Geben Sie die Anzahl der PostLC-Touchpoints ein, die Sie an Ihre Kontakte senden möchten, und klicken Sie auf **[!UICONTROL Speichern]**.
   ...
   ![1. Geben Sie die Anzahl der PostLC-Touchpoints ein, an die Sie pushen möchten](assets/additional-functionality-4.png)
