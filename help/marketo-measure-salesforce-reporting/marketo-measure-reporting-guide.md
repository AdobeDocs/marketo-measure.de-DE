...
**Ziele festlegen**: „Die erste Frage, die gestellt werden muss, lautet: „Warum messen wir?“ Lori Wizdo von [Forrester Research](https://go.forrester.com/) fasste es in einem [Marketo-Webinar](https://www.marketo.com/webinars/beyond-revenue-performance-real-kpis-of-b2b-marketing/) treffend zusammen. Ihr zufolge „messen wir, um eine Entscheidung oder den Wert des Marketings nachzuweisen oder zu validieren oder um besser zu werden (Prozessverbesserung).“ Wir möchten hinzufügen, dass die Erkenntnisse aus guter Messung auch einen Input und eine Anleitung für den Marketing-Planungsprozess liefern.
...
Support-Artikel: [Unterschied zwischen Käufer-Touchpoints und Käufer-Attribution-Touchpoints](/help/configuration-and-setup/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md)
...
Die [Attributionsmodelle](/help/attribution-models.md) die die beste insight für personenbasierte Metriken bieten, sind:
...
>[!TIP]
>
>Beginnen Sie mit der Anpassung des vordefinierten Berichts für jeden Berichtstyp „Leads mit Käufer-Touchpoints“ mit &quot;[!DNL Marketo Measure] 101 | Leads nach Kanal“. Dieser Bericht ist vorkonfiguriert verfügbar und ist eine hervorragende Sandbox, die wie in der obigen Tabelle beschrieben vorkonfiguriert ist und schnell für spezifischere Berichtsanforderungen angepasst werden kann.

**1.2 | Neue Leads nach Kampagne (oder detailliertere Einblicke)**
...
**2.2 | Marketing-qualifizierte Leads nach Kanal (nur für Einzelkontakt, nur CRM)**
...
<table>
 <tbody>
  ...
  <tr>
   <td>Filter</td>
   <td>'Formular-URL' ENTHÄLT (zum Beispiel)<br>
   <li>/ebook</li>
   <li>/Whitepaper</li>
...
* **Landingpage - Roh** (wird mit der Konfiguration „Online-Kanäle“ verwendet) auch eine gängige Eingabe für die Touchpoint-Unterdrückung auf der Registerkarte „Touchpoint-Einstellungen“ Ihrer Einstellungen)
...
Die [Attributionsmodelle](/help/attribution-models.md) die die beste insight für Opportunity-basierte Metriken bieten, sind:
...
**4.1 | Neue Chancen nach Marketing-Kanal**
...
>[!TIP]
>
>Für jeden Berichtstyp „Attribution-Touchpoints des Käufers mit Opportunities“ passen Sie zunächst den vordefinierten Bericht mit dem Titel &quot;[!DNL Marketo Measure] 101 | Opportunities nach Kanal“ an. Dieser Bericht ist vorkonfiguriert verfügbar und ist eine hervorragende Sandbox, die wie in der obigen Tabelle beschrieben vorkonfiguriert ist und schnell an spezifischere Berichtsanforderungen angepasst werden kann (der Bericht verwendet ein vorkonfiguriertes Vollpfadmodell. Stellen Sie daher sicher, dass Sie den Bericht so anpassen, dass er jedes andere Attributionsmodell enthält, in diesem Fall das W-förmige Modell).
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <li>Opportunity-Typ (es ist üblich, nach bestimmten Opportunities zu filtern, z. B. „Neues Unternehmen“ im Gegensatz zu allen Opportunities)<br>
   </td>
  </tr>
  <tr>
   <td>Datumsfeld/Datentyp</td>
...
**5. ROI (nur [!DNL Marketo Measure])**

Die [!DNL Marketo Measure] Discover-Dashboards bieten eine allgemeine Ansicht Ihrer Marketing-Performance anhand [!DNL Marketo Measure] Attributionsdaten. Diese aggregierten Dashboards bieten wichtige Daten zu Marketing-Ausgaben und ROI, die in Ihren CRM-Berichten nicht verfügbar sind. Diese vordefinierte Umgebung ermöglicht es Ihnen, Ihre Marketing-Leistung in Übereinstimmung mit Ihren ROI-Daten anzuzeigen, sodass Sie nachvollziehbare Entscheidungen in Bezug auf Ihr Marketing treffen können.

>[!TIP]
>
>Wenn Sie Fragen zu ROI, Ausgaben oder Kosten haben, ist [!DNL Marketo Measure] Discover der beste Ort für das Reporting!

Die [!DNL Marketo Measure] Discover-Dashboards bestehen aus Daten von Buyer Touchpoint und Attribution Touchpoints von Käufern sowie wichtigen CRM-Daten. Der Hauptunterschied zwischen CRM-Reporting und Reporting in [!DNL Marketo Measure] Discover ist, dass die Touchpoint-Daten in Discover stärker „aggregiert“ präsentiert und nach Dimension (Marketing-Kanal, Kampagne usw.) zusammengefasst werden Im Gegensatz zu einzelnen Touchpoint-Datensätzen, die dann zusammengefasst werden können. [!DNL Marketo Measure] „Entdecken“ wird verwendet, um auf allgemeiner Ebene zu verstehen, welche Ihrer Bemühungen die größte Wirkung auf Leads, Opportunities und Abschlüsse haben und wie viel Umsatz ihnen zugerechnet werden sollten. Nachdem wir den zugeordneten Umsatz anhand der verschiedenen Attributionsmodelle berechnet haben (der vollständige Pfad wird für die Zuordnung abgeschlossener gewonnener Umsätze/Buchungen empfohlen), können wir ihn dann mit der Höhe der Ausgaben in derselben Dimension (Marketing-Kanal, Unterkanal oder Kampagne) messen. Dies gibt uns dann den **ROI**.

>[!TIP]
>
>Eines der wichtigsten Dinge, die Sie beim Reporting in Discover beachten müssen, ist, welchen Datentyp Sie zum Filtern verwenden. Der Datentyp gibt an, welchen Datensatz [!DNL Marketo Measure] in den verschiedenen Kacheln verwendet.

* **Touchpoint-**: Zeigt die zugehörigen Daten an, die ein „Touchpoint-Datum“ im angegebenen Zeitraum hatten
* **Erstellungsdatum**: Zeigt die zugehörigen Daten an, die im angegebenen Zeitraum ein „Erstellungsdatum“ hatten
* **Abschlussdatum** Zeigt die zugehörigen Daten an, die im angegebenen Zeitraum ein „Abschlussdatum“ hatten

Bei der Berichterstattung über den ROI in [!DNL Marketo Measure] Discover wird empfohlen, einen „Datentyp“ = „Touchpoint-Datum“ zu verwenden. Um die Rendite eines jeden investierten Dollars zu ermitteln, müssen wir sicherstellen, dass die Einnahmen dem Zeitpunkt der Investition zugerechnet werden. &#39;Datentyp&#39; = „Touchpoint-Datum“ stellt sicher, dass die Berichte auf diese Weise strukturiert sind und nicht zum Zeitpunkt der Erstellung (Erstellungsdatum) oder des Abschlusses (Abschlussdatum) der Opportunity. Sehen wir uns das näher an:

Die unten hervorgehobenen Filter sind für einen ROI-fokussierten Bericht in [!DNL Marketo Measure] von entscheidender Bedeutung (Sie werden diese Filter wahrscheinlich in den Pinnwänden „Übersicht“, „CMO“ oder „ROI“ festlegen):

**5.1 | ROI im Übersichts-Board**

![5.1 | ROI im Übersichts-Board](assets/bizible-guide-1.png)

Der Datumsbereich legt nicht nur die Kohorte der Touchpoints (nach Touchpoint-Datum) fest, die eine Attribution erhalten, sondern definiert auch den Bereich, den die Kachel oder Spalten „Ausgaben“ darstellen.
[!DNL Marketo Measure] schaut einfach auf den Datumsbereich, um zu bestimmen, wie viel entweder insgesamt oder auf Marketing-Kanal-, Unterkanal- oder Kampagnenebene ausgegeben wurde. Siehe unten:

![Marketo Measure untersucht einfach den Datumsbereich, um zu bestimmen, wie](assets/bizible-guide-2.png)

Der obige Screenshot zeigt die Daten zu den Marketing-Ausgaben der letzten 3 vollständigen Monate. In diesem Beispiel wurden 12.970 US-Dollar für alle Kanäle ausgegeben. Diese Zahl besteht aus den Daten zu Marketingausgaben, die [!DNL Marketo Measure] aus Integrationen mit einem Ihrer verbundenen Werbekonten (Google AdWords, Bing Ads, Facebook Ads, LinkedIn, DoubleClick) und allen zusätzlichen Marketingausgaben hat, die in Ihr Konto hochgeladen oder automatisch aus Kampagnendatensätzen in Ihrem CRM abgerufen wurden. Das Beispiel zeigt auch, wie viel abgeschlossener gewonnener „Umsatz“ auch Touchpoints zugeordnet werden kann, die im selben Datumsbereich stattfanden (grüne Felder). So wird der ROI berechnet: Umsatz, der Touchpoints zugeordnet wird, die aus Investitionen im selben Datumsbereich stammen:

![Der obige Screenshot zeigt die Daten zu den Marketingausgaben in den letzten drei Jahren](assets/bizible-guide-3.png)
...
>[!TIP]
>
>Filtern Sie nach Marketing-Kanälen, Unterkanälen und/oder Kampagnen, von denen Sie wissen, dass die Daten zu Marketing-Ausgaben vollständig und korrekt sind. Das obige Beispiel gilt für alle Marketing-Kanäle. Wenn jedoch bei einigen Kanälen nicht die zugehörigen Daten zu Marketing-Ausgaben hochgeladen wurden, kann das ROI-Reporting ungenau sein. Sehen Sie sich das folgende Beispiel an, dieses Mal in der Pinnwand „ROI“, die sich auf die Kampagnen innerhalb des Marketing-Kanals der „Paid Search“ konzentriert, einem Kanal mit sehr detaillierten Daten zu Marketing-Ausgaben über die Integrationen.

![Filtern Sie nach Marketing-Kanälen, Unterkanälen und/oder Kampagnen, die Sie kennen](assets/bizible-guide-4.png)
