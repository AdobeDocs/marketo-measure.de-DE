...
![Öffnen Sie die Power BI-Datei der Adobe Marketo Measure-Berichtsvorlage.](assets/marketo-bi-1.png)

Sie finden Ihre spezifischen Server-, Warehouse- und Schemadaten in der [!DNL Marketo Measure]-Benutzeroberfläche auf der [!DNL Data Warehouse]-Informationsseite. Anweisungen zum Auffinden dieser Seite finden Sie [hier](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
![Um die in das Modell importierten Daten zu begrenzen, wird jede Tabelle festgelegt](assets/marketo-bi-2.png)
...
![Da die Datumsfilter auf das Änderungsdatum eines angewendet werden](assets/marketo-bi-3.png)
...
![Einige Umwandlungen wurden auf die Daten in Power Query angewendet.](assets/marketo-bi-6.png)
...
![Die meisten Tabellen im Marketo Measure Data Warehouse enthalten denormalisierte Dimensionen](assets/marketo-bi-7.png)
...
![Tabellen und Spalten wurden umbenannt, um sie benutzerfreundlicher zu gestalten und](assets/marketo-bi-5.png)

### Segmente umbenannt {#renamed-segments}

Da Segmentnamen angepasst werden können, verfügen sie im Snowflake Data Warehouse über generische Spaltennamen. [!DNL BIZ_SEGMENT_NAMES] ist eine Zuordnungstabelle, in der der generische Segmentname und der zugeordnete benutzerdefinierte Segmentname aufgelistet sind, die im Abschnitt Segment in der [!DNL Marketo Measure]-Benutzeroberfläche definiert sind. Die Tabelle „Segmentname“ wird verwendet, um die Segmentspalten in den Lead-Touchpoint- und Attributions-Touchpoint-Tabellen umzubenennen. Wenn kein benutzerdefiniertes Segment vorhanden ist, bleibt der allgemeine Segmentname erhalten.

![Da Segmentnamen angepasst werden können, verfügen sie über generische Spaltennamen in der](assets/marketo-bi-4.png)
...
![/Einfügen von Funktionen und Filtern.](assets/marketo-bi-8.png)

![/Einfügen von Funktionen und Filtern.](assets/marketo-bi-11.png)
...
![Um den Berechnungen im Modell Währungsumrechnungsfunktionen hinzuzufügen, haben wir folgende Möglichkeiten](assets/marketo-bi-10.png)
...
![Die in Snowflake gespeicherte Konversionsratentabelle enthält einen Datumsbereich](assets/marketo-bi-9.png)

## Datenmodell {#data-model}

Klicken Sie auf das folgende Bild, um es in voller Größe anzuzeigen.

[![Klicken Sie auf das Bild unten, um die vollständige Version anzuzeigen.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![Die Währungsumrechnungskennzahlen in diesem Modell ersetzen einen Wert von 1,0](assets/marketo-bi-13.png)
...
![Das Power BI-Modell wurde für benutzerdefinierte Tabellen um Definitionen erweitert](assets/marketo-bi-15.png)

![Das Power BI-Modell wurde für benutzerdefinierte Tabellen um Definitionen erweitert](assets/marketo-bi-16.png)

![Das Power BI-Modell wurde für benutzerdefinierte Tabellen um Definitionen erweitert](assets/marketo-bi-14.png)

Informationen zum Anzeigen von Definitionen für Spalten, die direkt aus [!DNL Snowflake] stammen, finden Sie in der [Data-Warehouse-Dokumentation](/help/data-warehouse-schema.md){target="_blank"}.
