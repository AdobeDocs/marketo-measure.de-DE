---
description: Kostenleitfaden für Marketing-Kanäle für Marketo Measure-Anwender
...
[Klicken Sie hier, um direkt zu den Anweisungen zu navigieren.](/help/marketing-channel-costs.md)
...
[Klicken Sie hier, um direkt zur häufig gestellten Frage zu gelangen.](/help/marketing-channel-costs.md)
...
![Gehen Sie zum Menü Mein Konto, klicken Sie auf Einstellungen und dann auf](assets/spend-management-4.png)
...
![Navigieren Sie rechts im Bildschirm und klicken Sie auf Aktuelle herunterladen](assets/spend-management-1.png)
...
![Um beispielsweise Facebook als Unterkanal und Social als anzugeben](assets/spend-management-2.png)
