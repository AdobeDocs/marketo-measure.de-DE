...
![Marketo Measure-Stufen 1-3](assets/marketo-overview-1.png)
...
![Von Marketern wird erwartet, dass sie ihre B2B-Daten (z. B. Konto, Opportunity)](assets/marketo-overview-2.png)
...
![Marketo Measure Ultimate setzt die Standardwährung auf USD bis zum](assets/marketo-overview-7.png)
...
Sobald die Auswahl der Sandbox-Zuordnung gespeichert wurde, können Sie sie in der Anwendung nicht mehr ändern. Wenden Sie sich zur Änderung an den [Marketo-Support](https://nation.marketo.com/t5/support/ct-p/Support?profile.language=de){target="_blank"}.
...
![Daten für eine bestimmte Entität (z. B. Konto) aus einer bestimmten Daten](assets/marketo-overview-6.png)
...
![Touchpoint-Regeln für Kampagnenmitglieder und Touchpoint-Regeln für Aktivitäten sind datensatzspezifisch.](assets/marketo-overview-5.png)

![Touchpoint-Regeln für Kampagnenmitglieder und Touchpoint-Regeln für Aktivitäten sind datensatzspezifisch.](assets/marketo-overview-8.png)
