...
Die URL-Tabelle im [Data Warehouse](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} enthält jetzt neben den Web-Daten-Tabellen ein Feld für den Seitentitel.
...
* [Neues Handbuch zum Entdecken von Dashboards](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
* [Entdecken Sie die Grundlagen von Dashboards](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
* [Dashboard „Umsatzübersicht“](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
* [Dashboard „Zugewiesener Umsatz“](/help/marketo-measure-discover-ui/attributed-revenue-dashboard.md){target="_blank"}
...
![Salesforce-Berichtstyp-Setup für Leads/Kontakte mit Touchpoints](assets/release-notes-2023-1.png)
...
![Berichtsspalten mit Hervorhebung der zu entfernenden alten FT/LC-Felder für Lead und Kontakt](assets/release-notes-2023-2.png)

* Touchpoint-Felder hinzufügen:

![Berichtsspalten mit Touchpoint-Feldern, die anstelle von FT/LC-Feldern hinzugefügt werden sollen](assets/release-notes-2023-3.png)
...
![Beispiel für eine Konfiguration des Touchpoint-Positionsfilters](assets/release-notes-2023-4.png)

![Datumsfeldfilter wurde auf Touchpoint-basierte Felder aktualisiert](assets/release-notes-2023-5.png)
