...
[!DNL Salesforce] Kunden klicken [hier](/help/configuration-and-setup/install-set-up.md).

[!DNL Microsoft Dynamics] Kunden klicken [hier](/help/microsoft-dynamics-crm-installation-guide.md).
