...
| Interaktionstyp | Beispiel | Touchpoint-Erzeugungsmethode |
| ---|---|--- |
...
| Interaktionstyp | Erzeugungsverfahren | Zuordnungsmethode |
| ---|---|--- |
...
> [CRM-Kampagnen über SFDC synchronisieren](/help/channel-tracking-and-setup/offline-channels/legacy-processes/syncing-offline-campaigns.md)
...
> [Erstellen von Touchpoints aus Vertriebsaktivitäten](/help/advanced-features/activities-attribution/salesforce-activities-attribution.md)
> [Häufig gestellte Fragen zu Aktivitäten und Zuordnen von Touchpoints zu Kanälen/Unterkanälen](/help/advanced-features/activities-attribution/activities-attribution-faq.md)
