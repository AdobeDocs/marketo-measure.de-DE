...
1. Wählen Sie **[!UICONTROL Installieren] für alle Benutzer**. 
   ...
   ![Salesforce AppExchange-Installationsdialogfeld für das Marketo Measure-Paket](assets/marketo-measure-salesforce-package-installation-and-set-up-1.png)

1. Sobald die Installation abgeschlossen ist, können Sie sie anzeigen.

   ![Detailseite für installierte Marketo Measure-Pakete in Salesforce](assets/marketo-measure-salesforce-package-installation-and-set-up-2.png)
