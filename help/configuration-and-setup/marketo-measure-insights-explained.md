...
![Zuerst sehen Sie im mittleren Teil Ihrer Erkenntnisse die Zahl](assets/marketo-app-1.png)
...
![Die Symbole, die wie Papier aussehen, zeigen an, dass eine Seitenansicht stattgefunden hat](assets/marketo-app-2.png)
...
![Das Symbol, das wie ein Becher aussieht, signalisiert, dass ein A/B-Test durchgeführt wird](assets/marketo-app-3.png)
...
![Wenn Sie auf eine bestimmte Sitzung klicken (Sie können dies tun, indem Sie auf klicken](assets/marketo-app-4.png)
