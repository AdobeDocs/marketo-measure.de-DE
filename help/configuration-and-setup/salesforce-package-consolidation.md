---
description: '''[!DNL Salesforce] Package-Konsolidierung - [!DNL Marketo Measure]'''
...
Das [Support-Team](https://nation.marketo.com/t5/support/ct-p/Support?profile.language=de){target="_blank"} steht Ihnen bei allen Fragen und für einen reibungslosen Übergang zum neuen konsolidierten Package zur Verfügung.
...
![bizible2extAdContentFTc enthält Outreach](assets/bizible-full-1.png)
...
![bizible2AdContentc enthält Outreach](assets/bizible-taxonomy-1.png)
