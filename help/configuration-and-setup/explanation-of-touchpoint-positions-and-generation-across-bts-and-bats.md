---
description: Erläuterung der Touchpoint-Positionen und -Generierung in allen BTs und  [!DNL BATs]  für Marketo Measure-Anwender
...
<table>
 <tbody>
  <tr>
   <th>Position von Buyer Touchpoint (BTs)</th>
...
<table>
 <tbody>
  <tr>
   <th>Position der Buyer Attribution Touchpoint (BAT)</th>
   <th>Touchpoint-Typ (Aktion, die Touchpoint-Trigger auslösen kann)</th>
   <th>Beschreibung des Touchpoints</th>
  </tr>
  <tr>
...
[!DNL Marketo Measure] verfügt über diese beiden Touchpoint-Datensätze, um den Journey und die Chancen einer Person genau zu verstehen. Diese beiden Touchpoint-Datensätze geben Ihnen einen klaren Überblick darüber, was von funnel bis zum Ende von funnel passiert ist.

Das folgende Beispiel zeigt den Datenfluss von Käufer-Touchpoints (BT) zu Käufer-Attribution-Touchpoints (BATs). In diesem Beispiel sind Person A und Person B beide Teil derselben Opportunity, die das Erstellungsdatum 3/7/2020 und das Abschlussdatum 5/6/2020 hat.
