---
description: Anleitung zur Attributionszuordnungsmethode für Marketo Measure-Benutzende
...
![Standardmäßig bietet Marketo Measure die Zuordnung von Konto-IDs. Dieses](assets/adobe-setup-1.png)
...
![Während die meisten Clients die Konto-ID-Zuordnung verwenden, kann Marketo Measure aussehen](assets/adobe-setup-2.png)
...
![Über die bloße Betrachtung der Kontaktrollen bei der Opportunity hinaus, Marketo](assets/adobe-setup-3.png)
