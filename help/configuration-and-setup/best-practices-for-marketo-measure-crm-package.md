...
>[!MORELIKETHIS]
> [Buyer Touchpoint-Paket aktualisieren](/help/configuration-and-setup/install-set-up.md)
> [[!DNL Marketo Measure] Berechtigungssätze](/help/configuration-and-setup/marketo-measure-permission-sets.md)
...
> [Verbinden von Marketo Measure mit Salesforce](/help/configuration-and-setup/connect-marketo-measure-to-salesforce.md)
