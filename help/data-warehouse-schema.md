---
description: Referenz für das Marketo Measure Data Warehouse-Schema mit detaillierten Tabellen und Spalten
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>Der Segmentwert für die 5. Kategorie, in die der Touchpoint fällt, wie in den Segmentdefinitionen in der [!DNL Marketo Measure]-App definiert. Im CRM als "Segmente" bezeichnet.</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>aw.6601259029.285114995.21703163075.[AdWords-Anzeige]_2018-09-06</td>
    </tr>
    <tr>
      <td>MODIFIED_DATE</td>
      <td>timestamp_ntz</td>
...
>[!IMPORTANT]
>
>Marketo Measure wird diese Tabelle Mitte 2024 einstellen. Wenn Sie sie selbst erstellen möchten, führen Sie [diese SQL-Abfrage](/help/assets/BIZ_FACTS.sql) aus.
