...
![Kunden-Journey-Zeitleiste mit vier Meilenstein-Touchpoints: Erstkontakt, Lead-Erstellung, Opportunity-Erstellung und Abgeschlossen-Gewonnen](assets/1-1.png)
...
![First-Touch-Modelldiagramm mit 100 % Attribution auf den Adwords-Kanal](assets/2.png)
...
![Diagramm des Lead-Erstellungsmodells mit 100 % Attribution auf dem LinkedIn-Kanal](assets/3.png)
...
![U-förmiges Modelldiagramm, das 50 % der Credits an Adwords und 50 % an LinkedIn zeigt](assets/4.png)
...
![W-förmiges Modelldiagramm, das jeweils 30 % an FT-, LC- und OC-Touchpoints mit 10 % an zwischengeschalteten Touchpoints anzeigt](assets/5.png)
...
![Diagramm des vollständigen Pfadmodells mit einer Gewichtung von jeweils 22,5 % für FT-, LC-, OC- und CW-Touchpoints mit 10 % für zwischengeschaltete Touchpoints](assets/6.png)
