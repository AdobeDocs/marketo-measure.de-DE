---
description: Versionshinweise für Marketo Measure-Benutzer für 2023
...
Die URL-Tabelle im [Data Warehouse](/help/data-warehouse-schema.md){target="_blank"} enthält jetzt neben den Web-Daten-Tabellen ein Feld für den Seitentitel.
...
* [Neues Handbuch zum Entdecken von Dashboards](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Entdecken Sie die Grundlagen von Dashboards](/help/discover-dashboard-basics.md){target="_blank"}
* [Dashboard „Umsatzübersicht“](/help/revenue-overview-dashboard.md){target="_blank"}
* [Dashboard „Zugewiesener Umsatz“](/help/attributed-revenue-dashboard.md){target="_blank"}
...
Wir werden unsere Exportaufträge an Lead-/Kontaktobjekte schrittweise auslaufen lassen, um unsere Integration zu vereinfachen und den Export in Salesforce-Standardobjekte zu vermeiden. Die unten aufgeführten denormalisierten Felder werden ebenfalls nicht mehr unterstützt, da Kundinnen und Kunden dieselben Daten von ihren Touchpoint-Objekten erhalten können. _&#x200B;**Die Timeline für die Einstellung ist Juni 2024.**&#x200B;_
...
![Erstellen neuer Berichtstypen für Leads und Kontakte mit oder ohne Touchpoints.](assets/release-notes-3.png)
...
![Lead/Kontakt-FT/LC-Felder entfernen:](assets/release-notes-5.png)

* Touchpoint-Felder hinzufügen:

![Touchpoint-Felder hinzufügen:](assets/release-notes-4.png)
...
![Der Filter Touchpoint-Position und alle Filter, die die FT/LC-Felder verwenden,](assets/release-notes-2.png)

![Der Filter Touchpoint-Position und alle Filter, die die FT/LC-Felder verwenden,](assets/release-notes-1.png)
...
* Um mit Dynamics in Verbindung zu bleiben, installieren Sie unsere neueste Paketversion v6.12. Alte Versionen `(<v6.12)` werden nicht mehr unterstützt. Diese Aktualisierung optimiert die Erstellung historischer Einträge, um die Speicherbelegung zu reduzieren.

* Die veraltete OAuth-Methode mit einem Aktualisierungs-Token wird nicht mehr unterstützt. In [dieser Anleitung](/help/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} finden Sie Informationen zur Aktualisierung Ihrer Anmeldeinformationen entsprechend der Best Practices von Microsoft zur Verwendung von ClientSecret.
...
[Dieser Artikel](/help/configuration-and-setup/salesforce-package-consolidation.md){target="_blank"} enthält Anleitungen zum Erstellen von Berichten und Dashboards aus den älteren Reporting-Paketen.
...
Der neue konsolidierte Link zur Paketinstallation [finden Sie hier](https://login.salesforce.com/packaging/installPackage.apexp?p0=04t1P000000VY6Z){target="_blank"}
