---
description: Einführung in die Oberfläche des Discover-Dashboards, Filter, Drill-Aktionen, Querfilterung, Exporte und Fokusmodus
...
![Bewegen Sie den Mauszeiger über die obere rechte Ecke eines Visuals, um eine schreibgeschützte Liste von anzuzeigen](assets/discover-3b-1.png)
...
![Bewegen Sie den Mauszeiger über ein visuelles Element, um festzustellen, ob es über eine Hierarchie verfügt; die](assets/discover-basics-7.png)
...
![Aktivieren Sie die Aufschlüsselung, indem Sie auf den einzelnen Abwärtspfeil klicken, der durch ein graues Symbol hervorgehoben wird](assets/discover-basics-8.png)
...
![Um jeweils ein Feld aufzuschlüsseln, aktivieren Sie die Aufschlüsselung](assets/discover-basics-2.gif)

Verwenden Sie das Doppelpfeil-Drilldown-Symbol, um zur nächsten Hierarchieebene zu gelangen.

![Verwenden Sie das Doppelpfeil-Drilldown-Symbol, um zur nächsten Hierarchie zu gelangen](assets/discover-basics-1.gif)

Verwenden Sie das Symbol Verzweigung , um Ihrer aktuellen Ansicht eine zusätzliche Hierarchieebene hinzuzufügen.

![Verwenden Sie das Symbol „Verzweigung“, um eine zusätzliche Hierarchieebene zu Ihrer Seite hinzuzufügen](assets/discover-basics-12.gif)
...
![Um die Daten hinter dem visuellen Element zu untersuchen, klicken Sie mit der rechten Maustaste auf das visuelle Element und](assets/discover-basics-13.gif)
...
![Um die zugrunde liegenden Daten aus einem visuellen Formular zu exportieren, bewegen Sie den Mauszeiger über die rechte Seite](assets/discover-basics-6.gif)
...
![Um ein bestimmtes visuelles Element oder eine bestimmte Kachel heranzuzoomen, bewegen Sie den Mauszeiger über die](assets/discover-basics-5.gif)
...
![Wenn Sie einen Wert oder eine Achsenbeschriftung in einer Visualisierung auswählen, wird eine andere gefiltert](assets/discover-basics-3.gif)
