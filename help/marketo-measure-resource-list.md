...
* [Was ist Marketing Attribution?](/help/marketing-attribution.md)
* [[!DNL Marketo Measure] Attributionsmodelle](/help/attribution-models.md)

**Konfiguration**

* [Einrichtung des Marketing-Kanals, Best Practice](/help/channel-tracking-and-setup/marketing-channels-and-subchannels.md)
* [Einrichtung des Online-Kanals](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
* [Offline-Kanal einrichten](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
* [Was sind UTM-Parameter?](/help/channel-tracking-and-setup/utm-parameters.md)
...
* [Gewähren  [!DNL Marketo Measure]  Zugriffs auf SFDC](/help/salesforce-access.md)
* Kontakt: [[!DNL Marketo] Support](https://nation.marketo.com/t5/support/ct-p/Support?profile.language=de){target="_blank"}
