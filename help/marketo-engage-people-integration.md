...
* SOLR aktiviert (wenden Sie sich an den [Marketo-Support](https://nation.marketo.com/t5/support/ct-p/Support?profile.language=de), um dieses zu aktivieren)
...
![Damit wir diese Duplikate erkennen können, müssen Sie Folgendes sicherstellen](assets/marketo-engage-programs-06.png)

![Damit wir diese Duplikate erkennen können, müssen Sie Folgendes sicherstellen](assets/marketo-engage-programs-07.png)
...
![Beim Reporting über Leads (Personen) in Marketo Measure Discover sehen Sie Folgendes](assets/bizible-discover-1.png)

![Beim Reporting über Leads (Personen) in Marketo Measure Discover sehen Sie Folgendes](assets/bizible-discover-2.png)
