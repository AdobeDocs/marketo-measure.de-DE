---
description: Erkunden Sie das ROI-Dashboard, um Kosten, Umsatz und ROI über Kanäle und Kampagnen hinweg im Zeitverlauf zu vergleichen
title: ROI-Dashboard
feature: Reporting
...
![Realisierter ROI: Realisierter zugewiesener Umsatz dividiert durch die Kosten im gefilterten Datum](assets/roi-dashboard-9.png)
...
![Gibt es Ausreißer-Kanäle oder Unterkanäle mit ungewöhnlich hohem oder niedrigem Wert](assets/roi-dashboard-8.png)
...
![Wie hängt der Trend des realisierten ROI mit einem signifikanten Marketing zusammen](assets/roi-dashboard-7.png)
...
![Wie haben sich die Kosten für einen bestimmten Kanal im Laufe der Zeit entwickelt?](assets/roi-dashboard-6.png)
...
![Welche Marketing-Pfade (Kanal, Unterkanal oder Kampagne) scheinen im Vergleich zu anderen unterfinanziert zu sein?](assets/roi-dashboard-5.png)
