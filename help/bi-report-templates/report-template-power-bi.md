...
![Power BI-Verbindungsdialogfeld für Marketo Measure-Vorlage](assets/marketo-measure-report-template-power-bi-1.png)

Sie finden Ihre spezifischen Server-, Warehouse- und Schemadaten in der [!DNL Marketo Measure]-Benutzeroberfläche auf der [!DNL Data Warehouse]-Informationsseite. Anweisungen zum Auffinden dieser Seite finden Sie [hier](/help/data-warehouse/data-warehouse-access-reader-account.md){target="_blank"}.
...
![Dialogfeld für native Abfragevalidierung in Power BI](assets/marketo-measure-report-template-power-bi-2.png)
...
![Abfrage-Editor mit Datumsfilterparametern](assets/marketo-measure-report-template-power-bi-3.png)
...
![Power Query Editor mit angewendeten Umwandlungsschritten](assets/marketo-measure-report-template-power-bi-4.png)
...
![Dialogfeld für die Spaltenauswahl mit entfernter Spaltenkonfiguration](assets/marketo-measure-report-template-power-bi-5.png)
...
![Schritt „Umbenannte Spalten“ mit Spaltennamenzuordnungen](assets/marketo-measure-report-template-power-bi-6.png)
...
![Zuordnungstabelle für Segmentnamen in Power Query](assets/marketo-measure-report-template-power-bi-7.png)
...
![Touchpoint-Tabelle mit ID-Umwandlung unter Berücksichtigung der Groß-/Kleinschreibung](assets/marketo-measure-report-template-power-bi-8.png)

![Kampagnentabelle mit Join-ID-Spalte für den Abgleich unter Berücksichtigung der Groß-/Kleinschreibung](assets/marketo-measure-report-template-power-bi-9.png)
...
![Opportunity-Tabelle mit Spalte „Konversionsrate des Unternehmens“](assets/marketo-measure-report-template-power-bi-10.png)
...
![Konversionsratentabelle mit erweiterten Datumszeilen](assets/marketo-measure-report-template-power-bi-11.png)

## Datenmodell {#data-model}

Klicken Sie auf das folgende Bild, um es in voller Größe anzuzeigen.

[![Power BI-Datenmodelldiagramm mit Tabellenbeziehungen](assets/marketo-measure-report-template-power-bi-12.png)](/help/bi-report-templates/assets/power-bi-data-model.png){target="_blank"}
...
![Formel zur Währungsumrechnung mit DAX-Berechnungslogik](assets/marketo-measure-report-template-power-bi-13.png)
...
![Tabelleneigenschaften mit Definitionsbeschreibungen](assets/marketo-measure-report-template-power-bi-14.png)

![Benutzerdefinierte Spaltendefinitionen im Datenmodell](assets/marketo-measure-report-template-power-bi-15.png)

![Messdefinitionen mit DAX-Formeln](assets/marketo-measure-report-template-power-bi-16.png)
