...
>[!NOTE]
>Wahrscheinlich verwenden Unternehmen verschiedene Identitätsanbieter (z. B. Ping Identity, Okta). Die in den folgenden Einrichtungsanweisungen und in der Benutzeroberfläche verwendeten Begriffe stimmen möglicherweise nicht direkt mit denen Ihres Identitätsanbieters überein.
...
![Seite „Authentifizierungseinstellungen“ mit der Option „Benutzerdefinierter SSO-Anmeldetyp“](assets/single-sign-on-1.png)
...
![SAML-Konfigurationsformular mit Benutzerattribut-Zuordnungsfeldern](assets/single-sign-on-2.png)
...
![Konfiguration der Benutzerrollenzuordnung mit Standardoptionen für Benutzer und Admin](assets/single-sign-on-3.png)
...
![Schaltfläche „SAML-Authentifizierung testen“ und Validierungsstatusmeldung](assets/single-sign-on-4.png)
...
![Schaltfläche „Speichern“ für Authentifizierungseinstellungen und Bestätigungsnachricht](assets/single-sign-on-5.png)
...
![Erfolgreicher SSO-Anmeldebestätigungsbildschirm](assets/single-sign-on-6.png)
...
![Salesforce-Setup-Menü mit Rollen unter „Benutzer verwalten“](assets/6.png)
...
![Navigation im Menü Dynamics-Einstellungen zu Sicherheitsrollen](assets/7.png)

![Liste der Dynamics-Sicherheitsrollen mit den verfügbaren Rollenoptionen](assets/8.png)
...
![Benutzerseite mit externen Google-Anmeldebenutzern](assets/9.png)
