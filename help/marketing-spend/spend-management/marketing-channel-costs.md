...
Die Summe aller Unterkanäle muss nicht den im Kanal eingegebenen Werten entsprechen, darf jedoch nicht größer sein als die im Kanal eingegebenen Werte. Wenn die Summe kleiner ist als der im Kanal eingegebene Wert, [!DNL Marketo Measure] fügt automatisch eine Zeile für &quot;Sonstige&quot;hinzu, um die Differenz abzudecken und Lücken zu füllen.
...
Bing Ads- und Google AdWords-Kosten müssen nicht eingegeben oder aktualisiert werden, da [!DNL Marketo Measure] ruft diese Daten automatisch von der API-Verbindung zu diesen Plattformen ab.
...
Navigieren Sie zu **[!UICONTROL Kosten]** Abschnitt [!DNL Marketo Measure] App und klicken Sie auf **[!UICONTROL Upload.CSV]**. Das System aktualisiert und gibt die neuen Informationen wieder.
