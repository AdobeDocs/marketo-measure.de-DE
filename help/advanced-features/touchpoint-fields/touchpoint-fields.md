...
![Seite mit den Einstellungen für Touchpoint-Felder mit der Option Berechnete Felder aktivieren](assets/one.png)
...
![Berechnete Feldkonfiguration für die Campaign Source-Feldextraktion](assets/two.png)
...
![Konfiguration des Rabatt-Code-Feldes beim Extrahieren des Promo-Parameters aus der URL](assets/three.png)
...
![Adobe Campaign-ID-Feld, das den 6-stelligen CID-Parameter extrahiert](assets/four.png)
...
![Mehrere berechnete Felder, die Länder- und Kampagnen-ID-Parameter extrahieren](assets/five.png)
...
![Zuordnung von Initiativen-Feldkampagnen zu Promotion-Kategorien](assets/six.png)
...
![Regionsname-Zuordnungstabelle mit numerischen Codes zu Regionsnamen](assets/seven.png)
...
![Verketten einer Konfiguration, die Segment- und Bewertungsfelder kombiniert](assets/eight.png)
...
![Benutzeroberfläche zur Segmenterstellung mit verfügbaren Touchpoint-Feldern](assets/nine.png)
...
![Dynamische Segmentkonfiguration mit geschweifter Klammer-Feldreferenz](assets/ten.png)

Die Regel verweist auf dasselbe Touchpoint-Feld und sucht nach Werten, die „nicht gleich null“ sind.

![Segmentregel mit ungleich null Bedingung](assets/eleven.png)
...
![Regex-Validierungstool, das einen gültigen Ausdruck in Grün anzeigt](assets/twelve.png)

![Regex-Validierungstool, das einen ungültigen Ausdruck in Rot anzeigt](assets/thirteen.png)
