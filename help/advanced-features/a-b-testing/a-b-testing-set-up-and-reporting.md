...
1. Bearbeiten Sie das Seiten-Layout der Hauptseite und fügen Sie die zugehörige Liste der **[!DNL Marketo Measure]-A/B-Tests** zu der Seite hinzu.
   ...
   ![Lead-Seiten-Layout-Editor mit der Liste &quot;Marketo Measure-A/B-Tests - Zugehörige Tests“ wird hinzugefügt](assets/1.png)
...
1. Klicken Sie auf die Schaltfläche mit dem [!UICONTROL Schraubenschlüssel]. Entfernen Sie das Standardfeld „Id“ aus der Liste der ausgewählten Felder. Fügen Sie die Felder **[!UICONTROL Experiment]**, **[!UICONTROL Variation]**, und **[!UICONTROL DateReported]** hinzu. Ändern Sie „[!UICONTROL Sortieren nach]“ in **[!UICONTROL Berichtsdatum]** und wählen Sie **[!UICONTROL Absteigend]** in der Dropdown-Liste.
   ...
   ![Dialogfeld für die Feldkonfiguration mit den Feldern „Experiment“, „Variante“ und „DatumBericht“ mit Sortiereinstellungen](assets/2.png)

1. Deaktivieren Sie unter [!UICONTROL Schaltflächen] die Option **[!UICONTROL Neu]**.

   ![Abschnitt „Schaltflächen“ mit deselektierter Schaltfläche „Neu“](assets/3.png)
...
![Berichtsliste mit den Berichtstypen für Marketo Measure-A/B-Tests für Lead, Kontakt und Opportunity](assets/4.png)
...
![Salesforce-Beispielbericht mit Marketo Measure-A/B-Tests mit Lead-Daten, einschließlich Experimenten und Varianten](assets/5.png)

**[!DNL Marketo Measure]-A/B-Test mit Opportunity**

![Salesforce-Beispielbericht mit Marketo Measure-A/B-Test mit Opportunity-Daten, einschließlich Umsatzauswirkungen](assets/6.png)
