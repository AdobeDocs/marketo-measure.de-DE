...
![Segmentlegende mit den in Admin verwendeten Symbolen](assets/1.png)
...
![Hinzufügen einer Segmentkategorie und eines Segmentnamens in Marketo Measure](assets/2.png)
...
![Regeleingabefelder zum Definieren eines Segmentfilters](assets/3.png)
