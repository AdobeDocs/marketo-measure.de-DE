...
|---|---|
| Advanced Currency | Der Kunde verfügt über eine erweiterte Währungsverwaltung und mehrere Währungen aktiviert, was bedeutet, dass er für verschiedene Zeiträume unterschiedliche Konversionsraten haben kann. |
...
| Währungs-Gebietsschema | Die einheitliche Währung, die für eine Organisation verwendet wird, wird auf der Seite „Unternehmensinformationen“ festgelegt. |
