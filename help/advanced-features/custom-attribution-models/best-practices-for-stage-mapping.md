...
>[!MORELIKETHIS]
>[Der Unterschied zwischen Funnel-Stadien und benutzerdefinierten Modellstadien](/help/advanced-features/custom-attribution-models/custom-attribution-model-and-setup.md#the-difference-between-funnel-stages-and-custom-model-stages)
