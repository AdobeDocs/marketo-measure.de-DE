...
1. Klicken Sie in [!DNL Marketo Measure] oben auf der Seite auf **[!UICONTROL Mein Konto]** > **[!UICONTROL Einstellungen]**.
   ...
   ![Marketo Measure-Navigationsmenü mit Optionen für „Mein Konto“ und „Einstellungen“](assets/data-warehouse-access-reader-account-1.png)

1. Klicken Sie im Menü links unter Sicherheit auf **[!UICONTROL Data Warehouse]**.

   ![Seitenleiste „Einstellungen“ mit Option &quot;Data Warehouse&quot; im Abschnitt Sicherheit](assets/data-warehouse-access-reader-account-2.png)

1. Diese Seite enthält den Link zu Ihrem Snowflake Data Warehouse und Ihrem Benutzernamen.

   ![Data Warehouse-Informationsseite mit Snowflake-URL und Benutzername](assets/data-warehouse-access-reader-account-3.png)
...
1. Klicken Sie auf den in der Snowflake-URL angegebenen Link, um zur Snowflake-Anmeldeseite zu gelangen, auf der Sie Ihren Benutzernamen und Ihr Kennwort eingeben. _Wenn Sie Ihr Kennwort nicht haben, können Sie es mit den folgenden Schritten zurücksetzen_.
   ...
   ![Snowflake-Anmeldeseite mit Feldern für Benutzernamen und Kennwort](assets/data-warehouse-access-reader-account-4.png)

1. Klicken Sie nach der Anmeldung **[!UICONTROL oben]** der Seite auf „Arbeitsblätter“.

   ![Snowflake-Benutzeroberfläche mit Navigationsoption für Arbeitsblätter](assets/data-warehouse-access-reader-account-5.png)
...
1. Die BIZIBLE_ROI_V3-Datenbankobjekte befinden sich auf der linken Bildschirmseite. Geben Sie Warehouse, Datenbank und Schema aus den Dropdown-Optionen oben im Abfragefenster ein. Es sollte nur eine Option für jeden geben. Jetzt können Sie Abfragen im Abfrage-Editor von Snowflake ausführen.
   ...
   ![Snowflake-Abfrage-Editor mit BIZIBLE_ROI_V3-Datenbank- und Dropdown-Selektoren](assets/data-warehouse-access-reader-account-6.png)
...
![Data Warehouse-Seite mit der Schaltfläche „Kennwort zurücksetzen“](assets/data-warehouse-access-reader-account-7.png)

![Temporäre Kennwortanzeige nach dem Zurücksetzen des Kennworts](assets/data-warehouse-access-reader-account-8.png)
...
* **Warehouse-Name** (nicht immer erforderlich)
  ...
  ![Data Warehouse-Informationsseite mit Details zu Datenbank- und Warehouse-Namen](assets/data-warehouse-access-reader-account-9.png)
