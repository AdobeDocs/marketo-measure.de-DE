...
![ROI Dashboard KPI-Kacheln für Kosten, zugeordneten Umsatz und ROI](assets/roi-dashboard-1.png)
...
![Kosten und Umsatz nach Kanal gestapeltes Balkendiagramm](assets/roi-dashboard-2.png)
...
![Realisierter Vergleich mit einfachem Trenddiagramm für den ROI](assets/roi-dashboard-3.png)
...
![Kosten im Zeitverlauf gestapeltes Balkendiagramm mit Drill-Steuerung](assets/roi-dashboard-4.png)
...
![Marketingausgaben nach Kanal-Balkendiagramm](assets/roi-dashboard-5.png)
...
>[!MORELIKETHIS]
> [Entdecken Sie die Grundlagen von Dashboards](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
> [Richtlinie für die Sichtbarkeit von Dashboard-Daten](/help/marketo-measure-discover-ui/dashboard-data-visibility-policy.md){target="_blank"}
