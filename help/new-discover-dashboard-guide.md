---
description: Ordnet ältere Discover-Dashboards den neu gestalteten Versionen zu und hebt wichtige Änderungen bei der Navigation und den Metriken hervor
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>Zusammenfassung zu Keyword- und Creative-ROI:</strong>Veraltet (siehe unten)</li>
        </ul>
      </td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>Zusammenfassung Schlüsselwort und Creative-ROI</strong>
        </p>
      </td>
      <td>
...
* **Datentyp, Metrik, Dimension, Gruppieren nach**: Diese Einstellungen sind jetzt für jedes Dashboard vordefiniert, um den insight-Versand zu optimieren. Detaillierte Informationen sind über QuickInfos und die zugehörige Dokumentation verfügbar.
* **Kampagnenquelle**
* **Konto-ID und Name**: Wird geprüft.

## Neue Ergänzungen und Verbesserungen {#new-additions-and-improvements}

Neue Funktionen finden Sie im Artikel [Discover Dashboard Basics](/help/discover-dashboard-basics.md){target="_blank"} .
