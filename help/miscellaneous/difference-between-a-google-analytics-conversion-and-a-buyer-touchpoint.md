---
description: Unterschied zwischen einer Google Analytics-Konversion und einem Buyer Touchpoint
...
**Was sind die Konversionen von Google Analytics?**

[!UICONTROL Google Analytics]-Konversionen werden dadurch bestimmt, wie ein Marketer oder ein Web-Entwickler „Ziel“-Abschlüsse auf einer bestimmten Website codiert. Google zufolge könnte man sich Ziele wie „einen Kauf (für eine E-Commerce-Site) tätigen, ein Game-Level ausfüllen (für eine mobile Gaming-App) oder ein Kontaktinformationsformular einreichen (für eine Marketing- oder Lead-Generierungsseite)“ vorstellen. Meistens sehen Marketing-Fachleute Ziele/Konversionen als jemanden, der ein Informationsformular ausfüllt.
...
Das bedeutet, dass Google Dankeseitenansichten als Konversion betrachtet. Aus Sicht von Google Analytics ist dies eine Erkenntnis, mit der die meisten Marketer einverstanden sind.
