...
Frischen Sie Ihr Gedächtnis auf, indem Sie [diesen Artikel](/help/marketing-spend/marketing-channel-costs.md) lesen, um zu erfahren, wie Sie Kosteninformationen hochladen.
...
Weitere Informationen über das [!DNL Marketo Measure]-Machine Learning-Modell finden Sie in [diesem Artikel](/help/advanced-features/custom-attribution-models/machine-learning-model-faq.md).
